				...
				<div class="row align-items-center">
					<div class="col-lg-2 col-6">
						<div class="logo-wrapper">
							<Link to="/" class="logo-black"><img src={logo} alt="logo" class="logo"></Link>
							<Link to="/" class="logo-white"><img src={logoWhite} alt="logo" class="logo"></Link>
						</div>
					</div>
					...
					<div class="col-xl-2 col-lg-3 col-6">
						<div class="header-right d-flex align-items-center justify-content-end">
							...
							<div class="lang-switcher d-none d-sm-block dropdown">
								<Link to="/" data-bs-toggle="dropdown"><span class="me-1"><i class="fa-solid fa-globe"></i></span>En</Link>
							...
							<div class="ofcanvus-btns next">
								<Link to="/" class="ofcanvus-btn d-none d-lg-block"><i class="fa-solid fa-bars-staggered"></i></Link>
								<Link to="/" class="mobile-menu-toggle d-lg-none"><i class="fa-solid fa-bars-staggered"></i></Link>
							</div>
						</div>
					</div>
				</div>
